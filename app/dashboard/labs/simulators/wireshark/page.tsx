import { WiresharkSimulator } from "@/components/labs/simulators/wireshark/wireshark-simulator";
 ...
 * the full viewport, like the real Wireshark desktop app window — a training
 * simulator reads as more convincing at real scale than boxed inside the
 * app's normal content margins.
 */
export default async function WiresharkSimulatorPage() {
  await requireUser();

  return (
    <div className="-m-6 h-[calc(100%+3rem)]">
      <SimulatorSessionTracker simulatorKey="wireshark" />
      <WiresharkSimulator />
    </div>
  );
}
